...
Cette liste est non exhaustive, cherchez par vous-même pour en trouver d'avantage !")
    ...
    p30 = ImageManager.getImageFromFile(@path+"/image/1260.gif",200,200)
    p31 = ImageManager.getImageFromFile(@path+"/image/1261.gif",200,200)
    p40 = ImageManager.getImageFromFile(@path+"/image/1262.gif",200,200)
    p11 = ImageManager.getImageFromFile(@path+"/image/1263.gif",200,200)
    p40 = ImageManager.getImageFromFile(@path+"/image/1264.gif",200,200)
    p41 = ImageManager.getImageFromFile(@path+"/image/1265.gif",200,200)
    p50 = ImageManager.getImageFromFile(@path+"/image/1266.gif",200,200)
    p51 = ImageManager.getImageFromFile(@path+"/image/1267.gif",200,200)
    p60 = ImageManager.getImageFromFile(@path+"/image/1268.gif",200,200)
    p61 = ImageManager.getImageFromFile(@path+"/image/1269.gif",200,200)
    p70 = ImageManager.getImageFromFile(@path+"/image/1270.gif",200,200)
    p71 = ImageManager.getImageFromFile(@path+"/image/1271.gif",200,200)
